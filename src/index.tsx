...
import { GenEricProps, GenEric } from "./gen-eric";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <gen-eric message="world!"></gen-eric>
   */
  return class GenEricBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): GenEricProps {
      const attrs = this.parseAttributes<GenEricProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<GenEric {...this.props} />, container);
    }
